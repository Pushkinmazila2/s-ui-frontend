export default {
  ...
  rule: {
    ...
    timeout: "Timeout",
    strategy: "Strategy",
    bulkEdit: "Mass editing",
    bulkHint: "One entry per line. Empty lines and duplicates are ignored.",
    bulkItems: "records",
    bulkClear: "Clean all",									 
  },
  ruleset: {
    ...
    remote: "Remote",
    local: "Local",
    importTitle: "Mass import of rulesets",
    importRulesTitle: "Importing rules",
    importUrlsHint: "One URL per line. The tag is determined from the file name without the extension.",
    importFileHint: "Upload it .a txt file with URLs, one per line.",
    importJsonHint: "Insert a JSON object with the rules and/or rule_set arrays. You can insert the entire \"route\" block: {...} or just its contents.",
    importFileJsonHint: "Upload it .a json file with the route block.",
    importUrlHint: "Specify a direct link to the JSON file (for example, a raw GitHub link).",																														  
    importPreview: "Preview",
    importSkipped: "already exist, shown in gray",
    importConflict: "Conflicts detected",
    importMerge: "Merge - add imported rules (skip duplicate set tags)",
    importReplace: "Replace - delete existing rules and sets, and import them again",
    importPasteUrls: "Insert URL",
    importUploadTxt: "Upload .txt",
    importUploadFile: "Upload a file",
    importPasteJson: "Insert JSON",
    importFromUrl: "By URL",
    importSelectTxt: "Choose .txt file",
    importSelectJson: "Choose .json file",
    importDetour: "Outbound to download",
    importIntervalDays: "Update interval (days)",
    importNone: "no",
    importParse: "Parse",
    importConflictDesc: "The config already has {rules} of rules and {rulesets} of rule sets. Select an action:",
    importMergeDo: "Combine and import",
    importReplaceDo: "Replace and import",
    importFinalOutbound: "Outbound by default (final)",
    importApplyFinal: "Apply as outbound by default",
    importFetch: "Download"
  },
  actionsAdditions: {
    import: "Import",
    apply: "Apply",
  ...
  ruleAdditions: {
    ...
    bulkHint: "One entry per line. Empty lines and duplicates are ignored.",
    bulkItems: "records",
    bulkClear: "Clear everything",
  },
  routeCheck: {
    title: "Checking the routing rules",
    packetParams: "Package Parameters",
    domain: "Target Domain / Adress",
    destIp: "Target IP",
    srcIp: "Source IP",
    destPort: "Target port",
    srcPort: "Source port",
    ruleSetHint: "Select Rule Set to check",
    ruleSetHintSub: "Only the marked Rule Set will be counted in the check.",
    check: "Check",
    result: "Verification results",
    matched: "Match found (rule №{index})",
    noMatch: "No match found",
    noMatchDesc: "The traffic will go through the end rule: {final}",
    status: "Status",
    status_winner: "Winer",
    status_non_terminating: "Non-terminating",
    status_no_match: "There are no matches",
    status_skipped: "Skipped",
    inbound_missing: "inbound is missing from the package",
    inbound_mismatch: 'inbound "{value}" not found in [{list}]',
    inbound_ok: "inbound ✓",
    inbound_skipped: "inbound skipped",
    domain_exact: 'domain точное match: "{value}"',
    domain_suffix: 'domain suffix match: "{value}"',
    domain_keyword: 'domain keyword match: "{value}"',
    domain_regex: 'domain is a regex match: "{value}"',
    ip_cidr_ok: "ip_cidr ✓",
    ip_cidr_mismatch: 'ip_cidr "{value}" not found in [{list}]',
    reset: "Throw off(DROP)",						  
  },
  dns: {
    add: "Add Dns Server",
    title: "Dns Servers",
